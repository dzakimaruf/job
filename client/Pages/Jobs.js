            ...
            <div className="flex-1 px-2 flex gap-x-4 justify-center lg:ml-6 lg:justify-start mt-5">
                ...
                <div className="relative flex items-start py-5">
                    <div className="flex justify-end">
                        ...
                        <button
                            type="submit"
                            className="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
